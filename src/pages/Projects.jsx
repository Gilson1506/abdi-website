...
const Projects = () => {
  ...
  const loadProjects = () => {
    ...
    // Se não houver projetos salvos, criar alguns exemplos
      ...
      const exampleProjects = [
        {
          ...
          description:
            'Uma plataforma inovadora para facilitar o ensino à distância com ferramentas interativas e gamificação.',
          category: 'Educação',
          status: 'completed',
          date: '2024-01-15',
          author: 'Equipa Educação',
          logo: 'Modern educational platform with interactive learning tools',
          webapp: 'https://exemplo-educacao.com',
          pdf: 'projeto-educacao.pdf',
        },
        {
          id: 2,
          title: 'Sistema de Gestão Sustentável',
          description:
            'Aplicação para monitorização e gestão de recursos sustentáveis em empresas e organizações.',
          category: 'Sustentabilidade',
          status: 'in-progress',
          date: '2024-02-20',
          author: 'Equipa Verde',
          logo: 'Sustainable resource management dashboard with green energy metrics',
          webapp: null,
          pdf: 'projeto-sustentabilidade.pdf',
        },
        {
          id: 3,
          title: 'App de Saúde Mental',
          description:
            'Aplicação móvel para apoio à saúde mental com meditação guiada, acompanhamento de humor e recursos de bem-estar.',
          category: 'Saúde',
          status: 'planned',
          date: '2024-03-10',
          author: 'Equipa Bem-Estar',
          logo: 'Mental health mobile app interface with meditation and wellness features',
          webapp: null,
          pdf: 'projeto-saude-mental.pdf',
        },
      ];

  ...
  const team = [
    {
      name: 'Ana Silva',
      role: 'Presidente',
      image: 'Team leader with vision and experience',
      description:
        'Especialista em inovação e gestão de projetos com mais de 10 anos de experiência.',
    },
    {
      name: 'João Santos',
      role: 'Vice-Presidente',
      image: 'Technology expert and project manager',
      description:
        'Engenheiro de software apaixonado por tecnologia e desenvolvimento sustentável.',
    },
    {
      name: 'Maria Costa',
      role: 'Secretária',
      image: 'Communication specialist and community manager',
      description:
        'Especialista em comunicação e gestão de comunidades digitais.',
    },
    {
      name: 'Pedro Oliveira',
      role: 'Tesoureiro',
      image: 'Financial expert and business analyst',
      description:
        'Analista financeiro com experiência em gestão de organizações sem fins lucrativos.',
    },
  ];
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  Fundada em 2020, a nossa associação nasceu da necessidade de
                ...
                <p>
                  ...
                  inovação, e hoje somos uma comunidade vibrante de mais de 250
                  membros ativos, incluindo empreendedores, desenvolvedores,
                  designers e visionários.
                </p>
                <p>
                  Ao longo dos anos, facilitámos o desenvolvimento de mais de 45
                  projetos, organizámos mais de 120 eventos e criámos uma
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center">
                  ...
                  <div className="text-gray-700 text-sm">Membros Ativos</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-600">45+</div>
                  <div className="text-gray-700 text-sm">Projetos</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-600">120+</div>
                  <div className="text-gray-700 text-sm">Eventos</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-600">4</div>
                  <div className="text-gray-700 text-sm">Anos</div>
                </div>
              </div>
            </motion.div>
          </div>

  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'E-mail',
      content: 'geral@bolsadeideias.info',
      description: 'Resposta em até 24 horas',
    },
    {
      icon: Phone,
      title: 'Telefone',
      content: '+244 935 358 777',
      description: 'Segunda a Sexta, 9h-18h',
    },
    {
      icon: MapPin,
      title: 'Endereço',
      content: 'Cassengo, Luanda\nBairro Social da Juventude',
            ...
            >
              ...
              <div className="bg-gray-100 rounded-2xl h-64 mb-6 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 text-sm mt-2">Luanda, Angola</p>
                </div>
              </div>
